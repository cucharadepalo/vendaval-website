...
@section('content')
	<main>
		<section id="splash" class="w-full pt-16 pb-6 bg-(--vdl-splash-bg-color) bg-cover bg-center bg-no-repeat text-(--vdl-splash-txt-color) xl:bg-contain xl:py-30" @isset($splash)style="background-image: url({{ $splash->getFullUrl() }})"@endisset>
