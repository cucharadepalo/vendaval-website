<footer class="w-full min-h-4 bg-(--vdl-splash-bg-color) text-(--vdl-splash-txt-color) text-sm">
	<div class="px-6 py-12 grid grid-cols-1 gap-6 items-start md:px-16 xl:px-20">
		@isset($edition)
			...
			<div class="space-y-2">
				...
				<div class="flex flex-wrap items-center justify-start gap-6">
					<img src="{{ asset('images/logos/deputacion-lugo.png') }}" alt="Logo Deputación de Lugo" loading="lazy" width="185" height="50">
					...
					<img src="{{ asset('images/logos/sober-logo.svg') }}" alt="Sober" loading="lazy" width="93" height="40">
				</div>
			</div>
			<div class="space-y-2">
